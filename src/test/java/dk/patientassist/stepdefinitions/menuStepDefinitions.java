...
public class menuStepDefinitions {
    ...
    // dishDTO = new DishDTO("Kylling i karry", "godt med karry",
    // LocalDate.ofYearDay(2025, 24), LocalDate.now(),
    // DishStatus.TILGÆNGELIG); // id, name, description, available_from,
    // available_until, status
    // orderDTO = new OrderDTO(201, LocalDateTime.now(), "Ingen allergier", dishDTO,
    // OrderStatus.VENTER); // id,
    // // bed_id,
    // // order_time,
    // // note,
    // // dish,
    ...
    // }
    //
    // @Then("it should be clearly indicated \\(e.g. with a “Sold Out” label) that
    // the dish cannot be ordered")
    // public void
    // itShouldBeClearlyIndicatedEGWithASoldOutLabelThatTheDishCannotBeOrdered() {
    // // This step will be implemented by another team member - belongs to Task 5.
    // }
}
