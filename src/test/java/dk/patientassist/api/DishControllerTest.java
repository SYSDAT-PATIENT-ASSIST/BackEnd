...
public class DishControllerTest {
    ...
    void testCreateDish_Success() {
        int id = createTempDish("Dish Create", DishStatus.AVAILABLE, Allergens.EGGS);
    ...
    void testUpdateDish_Success() {
        int id = createTempDish("Dish Update", DishStatus.AVAILABLE, Allergens.SOY);

        Map<String, Object> update = baseDishData();
        update.put("name", "Updated Name");
        update.put("status", DishStatus.SOLD_OUT.name());
    ...
    void testGetDishById() {
        int id = createTempDish("GetById", DishStatus.AVAILABLE, Allergens.GLUTEN);
    ...
    @Test
    void testDeleteDish() {
        int id = createTempDish("DeleteDish", DishStatus.AVAILABLE, Allergens.FISH);
    ...
    void testFilterDishesByStatusAndAllergen() {
        createTempDish("FilterDish", DishStatus.AVAILABLE, Allergens.MUSTARD);
    ...
    private Map<String, Object> baseDishData() {
        ...
        data.put("status", DishStatus.AVAILABLE.name());
        data.put("kcal", 450);
        data.put("protein", 30);
        data.put("carbohydrates", 35);
        data.put("fat", 15);
        data.put("allergens", Allergens.SESAME.name());
        return data;
    }
