...
public class ServerConfig {
    ...
    public static Javalin setup(Mode mode) {
        ...
        /* CORS */
        jav.before(ServerConfig::corsHeaders);
        jav.options("/*", ServerConfig::corsHeadersOptions);
        /* EXCEPTIONS */
        jav.exception(HttpResponseException.class, ServerConfig::jsonErrorResponse);
